...
- **Current version**: v10.4.51 - ui(quiz-mobile): keep primary answer actions above the fixed bottom tab bar on phones. No question content or audit queues changed.
