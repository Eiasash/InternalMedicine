...
const HTML_URLS=['pnimit-mega.html','manifest.json','shared/fsrs.js','src/core/constants.js','src/core/utils.js','src/core/state.js','src/sr/spaced-repetition.js','src/quiz/engine.js','src/ai/client.js','src/ai/explain.js'];
