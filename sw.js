...
const JSON_DATA_URLS=['data/questions.json','data/highyield.json','data/topics.json','data/notes.json','data/drugs.json','data/flashcards.json','data/tabs.json','data/distractors.json','harrison_chapters.json'];
